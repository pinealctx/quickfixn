...
public class RequestForPositionsAck : Message
{
    ...
    {
        Header.SetField(new MsgType("AO"));
    }

    public RequestForPositionsAck(
            PosMaintRptID aPosMaintRptID,
            PosReqResult aPosReqResult,
            PosReqStatus aPosReqStatus,
            Account aAccount,
    ...
    public void Set(PosReqStatus val) { PosReqStatus = val; }
    public PosReqStatus Get(PosReqStatus val) { GetField(val); return val; }
    public bool IsSet(PosReqStatus val) { return IsSetPosReqStatus(); }
    public bool IsSetPosReqStatus() { return IsSetField(Tags.PosReqStatus); }

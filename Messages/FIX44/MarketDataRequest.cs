...
public class MarketDataRequest : Message
{
    ...
    public void Set(AggregatedBook val) { AggregatedBook = val; }
    public AggregatedBook Get(AggregatedBook val) { GetField(val); return val; }
    public bool IsSet(AggregatedBook val) { return IsSetAggregatedBook(); }
    ...
    public void Set(MDImplicitDelete val) { MDImplicitDelete = val; }
    public MDImplicitDelete Get(MDImplicitDelete val) { GetField(val); return val; }
    public bool IsSet(MDImplicitDelete val) { return IsSetMDImplicitDelete(); }
    public bool IsSetMDImplicitDelete() { return IsSetField(Tags.MDImplicitDelete); }
    ...
    public void Set(ApplQueueAction val) { ApplQueueAction = val; }
    public ApplQueueAction Get(ApplQueueAction val) { GetField(val); return val; }
    public bool IsSet(ApplQueueAction val) { return IsSetApplQueueAction(); }
    public bool IsSetApplQueueAction() { return IsSetField(Tags.ApplQueueAction); }

    public ApplQueueMax ApplQueueMax
    {
        get
        {
            ApplQueueMax val = new();
            GetField(val);
            return val;
        }
        set  => SetField(value);
    ...
    public void Set(ApplQueueMax val) { ApplQueueMax = val; }
    public ApplQueueMax Get(ApplQueueMax val) { GetField(val); return val; }
    public bool IsSet(ApplQueueMax val) { return IsSetApplQueueMax(); }
    public bool IsSetApplQueueMax() { return IsSetField(Tags.ApplQueueMax); }
    ...
    {
        public static int[] DefaultFieldOrder = [Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.NoSecurityAltID, Tags.Product, Tags.CFICode, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.OptAttribute, Tags.ContractMultiplier, Tags.CouponRate, Tags.SecurityExchange, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.NoUnderlyings, Tags.NoLegs, 0];

        [Obsolete("Use DefaultFieldOrder instead.  This will be removed in a future release.")]
        public static int[] fieldOrder = {Tags.Symbol, Tags.SymbolSfx, Tags.SecurityID, Tags.SecurityIDSource, Tags.NoSecurityAltID, Tags.Product, Tags.CFICode, Tags.SecurityType, Tags.SecuritySubType, Tags.MaturityMonthYear, Tags.MaturityDate, Tags.CouponPaymentDate, Tags.IssueDate, Tags.RepoCollateralSecurityType, Tags.RepurchaseTerm, Tags.RepurchaseRate, Tags.Factor, Tags.CreditRating, Tags.InstrRegistry, Tags.CountryOfIssue, Tags.StateOrProvinceOfIssue, Tags.LocaleOfIssue, Tags.RedemptionDate, Tags.StrikePrice, Tags.StrikeCurrency, Tags.OptAttribute, Tags.ContractMultiplier, Tags.CouponRate, Tags.SecurityExchange, Tags.Issuer, Tags.EncodedIssuerLen, Tags.EncodedIssuer, Tags.SecurityDesc, Tags.EncodedSecurityDescLen, Tags.EncodedSecurityDesc, Tags.Pool, Tags.ContractSettlMonth, Tags.CPProgram, Tags.CPRegType, Tags.NoEvents, Tags.DatedDate, Tags.InterestAccrualDate, Tags.NoUnderlyings, Tags.NoLegs, 0};

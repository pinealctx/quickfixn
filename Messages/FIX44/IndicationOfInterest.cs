...
public class IndicationOfInterest : Message
{
    ...
    public class NoLegsGroup : Group
    {
        ...
        public void Set(LegIOIQty val) { LegIOIQty = val; }
        public LegIOIQty Get(LegIOIQty val) { GetField(val); return val; }
        public bool IsSet(LegIOIQty val) { return IsSetLegIOIQty(); }
        public bool IsSetLegIOIQty() { return IsSetField(Tags.LegIOIQty); }

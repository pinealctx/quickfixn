...
public static class Tags
{
    ...
    public const int CounterpartID = 5006;
    public const int Balance = 5020;
    public const int AvailableForMarginTrading = 5021;
    public const int CreditLimit = 5022;
    public const int SecurityDeposit = 5023;
    public const int ClosedPL = 5024;
    public const int OpenPL = 5025;
    public const int MarginRequirement = 5026;
    public const int NetOpenPosition = 5027;
    public const int CreditLimitNOP = 5028;
    public const int InitialAccount = 5888;
    public const int FixingDate = 6203;
    public const int ttl = 10000;
    public const int deviation = 10001;
    public const int CustomField = 1021;
    public const int MinOrderSize = 93636;
    public const int MaxOrderSize = 93637;
    public const int PlacedTime = 9364;
    public const int LiquidityAction = 9374;
    public const int IOIID = 23;
